...
<div className='flex text- justify-center items-center gap-2'>
  <div>
...
<button onClick={changeUnitTemp} className='bg-blue-500 py-2 px-6 text-white fond-bold rounded-full hover:bg-blue-800 duration-200 text-sm block mx-auto mt-4'>Change C°/°F</button>
    </section>
  )
}
